$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-load-main-panel"] = new basejavascript("default-load-main-panel", "", "test", {'widget_type': 'basejavascript', 'fields': {'title': '', 'title2': '', 'icon': '', 'icon_style': ''}, 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'mdi-home'}, 'static_css': {'title_style': 'color: #ffffff;font-weight: 800;margin-top:6px;', 'title2_style': 'color: #ffffff;font-weight: 400;', 'widget_style': 'background-color:var(--background-color);color: #00aaff;'}, 'css': {'icon_active_style': 'color: #ffffff； top：0;', 'icon_inactive_style': 'color: #ffffff;'}, 'static_icons': [], 'icon_inactive': 'mdi-home', 'dashboard': 'Main', 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default'})
    ...
    ha_status(stream_url, "系统", widgets, "ws");
