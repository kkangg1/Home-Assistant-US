$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-clock"] = new baseclock("default-clock", "", "HADashboard-Theme-Metro-master", {'widget_type': 'baseclock', 'fields': {'date': '', 'time': ''}, 'static_css': {'date_style': 'visibility: hidden;height: 0px;color: black;', 'time_style': 'vertical-align: top;text-align: right;font-weight: 300;padding-right: 10px;color: white;', 'widget_style': 'background-color: transparent;display: inline;'}, 'static_icons': [], 'icons': [], 'css': {}, 'time_format': '24hr', 'show_seconds': 1, 'date_style': 'color: black;', 'time_style': 'color: white;', 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default'})
    
        widgets["default-light"] = new baseswitch("default-light", "", "HADashboard-Theme-Metro-master", {'widget_type': 'baseswitch', 'entity': 'switch.outlet_382c', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'switch.outlet_382c'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'switch.outlet_382c'}, 'fields': {'title': '客厅灯', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'mdi-white-balance-incandescent', 'icon_off': 'mdi-white-balance-incandescent'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #fff176;animation: rotate2 2s 1;', 'icon_style_inactive': 'color: #ffffff;'}, 'static_css': {'title_style': 'color: #ffffff;', 'title2_style': 'color: #ffffff;', 'state_text_style': 'color: #ffffff;', 'widget_style': 'background-color: #52aaec;'}, 'icon_on': 'mdi-white-balance-incandescent', 'icon_off': 'mdi-white-balance-incandescent', 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default'})
    
        widgets["default-load-main-panel"] = new basejavascript("default-load-main-panel", "", "HADashboard-Theme-Metro-master", {'widget_type': 'basejavascript', 'fields': {'title': '总控开关', 'title2': '', 'icon': '', 'icon_style': ''}, 'icons': {'icon_active': 'fa-spinner fa-spin', 'icon_inactive': 'fa-home'}, 'static_css': {'title_style': 'visibility: hidden;height: 0px;', 'title2_style': 'color: #ffffff;', 'widget_style': 'background: transparent;'}, 'css': {'icon_active_style': 'color: #eeeeee;', 'icon_inactive_style': 'color: #eeeeee;'}, 'static_icons': [], 'icon_inactive': 'fa-home', 'dashboard': 'Main', 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'namespace': 'default'})
